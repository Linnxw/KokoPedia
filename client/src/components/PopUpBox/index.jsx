...
export default function index({active,event,detail}){
  return (
  <div className={`w-screen min-h-screen ${active ? "backdrop-blur-sm bg-white/35" :"backdrop-blur-0 opacity-0 -z-10"} transition-all ease-in-out duration-200 fixed top-0 left-0 flex flex-col items-center justify-center`}>
