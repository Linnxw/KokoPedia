...
const {placeholder,type,name="",input,event}=props
  ...
  return(
   <div className="w-[90%] relative mx-auto flex items-center justify-start tracking-wide font-noto font-medium">
     <input type={type} name={name} className="w-full peer border-b-[.8px] focus:border-b border-grayTxt outline-none text-sm py-1 font-semibold tracking-wide focus:border-greenPrimary caret-greenPrimary text-slate-600" onChange={event}/>
